...
namespace IdentityManager.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, UrlEncoder urlEncoder, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel viewModel, string returnurl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync("Test",viewModel.Email, "Confirm Email - Identity Manager",
            ...
            viewModel.RoleList = _roleManager.Roles.Select(r => r.Name).Select(r => new SelectListItem
            {
                Text = r,
                Value = r
            });
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync("Shams",model.Email, "Reset Password - Identity Manager",
